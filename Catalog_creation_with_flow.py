...
def create_composition(composition_db: sm.Composition, catalog: cat_.Catalog) -> cat_.Item:
    item = cat_.Item(composition_db.id, composition_db.name, composition_db.code, composition_db.group_id, description=composition_db.name)
...
def create_attribution(attribution_db: sm.Attribution, item: cat_.Item, catalog: cat_.Catalog, coefficient: int) -> cat_.StepResource:
...
def main():
    ...
    columns += [
        ...
        [
            create_column('Flow', 'String', 'RollUp', None, True, None, 'dimensionless', True), {
                ObjectResource: {},
                StepResource: {},
                Resource: {}
            }
        ...
        [
            create_column('Category', 'String', 'RollUp', None, True, None, 'dimensionless', True), {
                ObjectResource: {},
                StepResource: {},
                Resource: {}
            }
        ...
        [
            create_column('Uncertainty', 'String', 'RollUp', None, True, None, 'dimensionless', True), {
                ObjectResource: {},
                StepResource: {},
                Resource: {}
            }
        ...
        [
            create_column('AvoidedWaste', 'String', 'RollUp', None, True, None, 'dimensionless', True), {
                ObjectResource: {},
                StepResource: {},
                Resource: {}
            }
        ...
        [
            create_column('Amount', 'Number', 'RollUp', None, True, None, 'any', True), {
                ObjectResource: {},
                StepResource: {},
                Resource: {}
            }
        ...
        [
            create_column('Provider', 'String', 'RollUp', None, True, None, 'dimensionless', True), {
                ObjectResource: {},
                StepResource: {},
                Resource: {}
            }
        ...
        [
            create_column('DataQualityEntry', 'String', 'RollUp', None, True, None, 'dimensionless', True), {
                ObjectResource: {},
                StepResource: {},
                Resource: {}
            }
        ...
        [
            create_column('Description', 'String', 'RollUp', None, True, None, 'dimensionless', True), {
                ObjectResource: {},
                StepResource: {},
                Resource: {}
            }
    ...
    print('catalog')
    Navisworks(takeoff).write('output/Catalog_process.xml')
